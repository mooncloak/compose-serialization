...
fun MavenPublication.mavenCentralPom() {
    pom {
        name.set("compose-serialization")
        description.set("Kotlinx serializations for Compose Multiplatform UI models.")
        url.set("https://github.com/mooncloak/compose-serialization")
        ...
        issueManagement {
            url.set("https://github.com/mooncloak/compose-serialization/issues")
        ...
        developers {
            developer {
                ...
                roles.set(setOf("Primary compose-serialization developer. 💪"))
            }
        }

        scm {
            connection.set("https://github.com/mooncloak/compose-serialization.git")
            developerConnection.set("https://github.com/mooncloak/compose-serialization.git")
            url.set("https://github.com/mooncloak/compose-serialization")
        }
    }
}
